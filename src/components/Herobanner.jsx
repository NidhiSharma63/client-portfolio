...
import { HeroIntroTypography,HeroSubHeadingTypo } from '../material UI/typography';
    ...
    <>
      ...
      marginTop='100px'>
        ...
        className='hero-banner'>
          ...
          <Box
          className='hero-image-wrapper translate-right'
          >
            <Box
              component='img'
            ...
            <Box
             ...
             >
              <a className='github' href='https://github.com/NidhiSharma63'>
                <ThemeProvider theme={IconTheme}>
                  <GitHubIcon className='github-icon'/>
                </ThemeProvider>
              </a>
              <a className='linkdin' href="https://github.com/NidhiSharma63">
                <ThemeProvider theme={IconTheme}>
                  <LinkedInIcon className='linkdin-icon'/>
                </ThemeProvider>
              </a>
              <a className='twitter' href="https://github.com/NidhiSharma63">
                <ThemeProvider theme={IconTheme}>
